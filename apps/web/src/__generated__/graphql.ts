...
export type CourseHeadingFragmentFragment = {
  __typename?: 'Course';
  _id: string;
  title: string;
  type: CourseType;
  description: string;
} & { ' $fragmentName'?: 'CourseHeadingFragmentFragment' };
...
export type PageFragmentFragment = {
  ...
  question?:
    | ({ __typename?: 'Question' } & {
        ' $fragmentRefs'?: {
          QuestionFragmentFragment: QuestionFragmentFragment;
        };
      })
    | null;
  progress?: {
  ...
  courses: Array<
    {
      ...
      ' $fragmentRefs'?: {
        CourseHeadingFragmentFragment: CourseHeadingFragmentFragment;
      };
    }
  >;
};
...
export const CourseHeadingFragmentFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'CourseHeadingFragment' },
      typeCondition: {
        kind: 'NamedType',
...
} as unknown as DocumentNode<CourseHeadingFragmentFragment, unknown>;
...
export const GetAllCoursesDocument = {
  ...
  definitions: [
    ...
    ...CourseHeadingFragmentFragmentDoc.definitions,
  ],
